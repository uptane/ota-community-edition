...
- The GUI is browser-based and cannot execute host commands directly (for example, `scp`, `rsync`, `ssh`, or running `aktualizr`); it can only generate commands for you.
