...
// //     cy.get('.how-it-works .sub-title.title-2').should(
// //       'have.html',
// //       'How it works',
// //     );
// //   });
// //   it('has "Step 1" sub header', () => {
// //     cy.get('.how-it-works .steps .step-1 .title-3').should(
// //       'have.html',
// //       'Step 1',
// //     );
// //   });
// //   it('has "Step 2" sub header', () => {
// //     cy.get('.how-it-works .steps .step-2 .title-3').should(
// //       'have.html',
// //       'Step 2',
// //     );
// //   });
...
// //     .should(
// //       'contain',
// //       'Boot a Toradex SoM into Toradex Easy Installer right out of the box and select "TorizonCore with Docker".',
// //     )
// //     .find('h6')
...
// //     .should(
// //       'contain',
// //       'Manage fleets of Toradex devices and keep them up-to-date with your latest application & TorizonCore releases.',
// //     )
// //     .find('h6')
...
// //     .find('img')
// //     .should('have.attr', 'src')
// //       .and('be.eq', 'img/onboarding-install.svg');
// //   });
// //   it('has "Step 2" image', () => {
...
// //     .should(($button) => {
// //       expect($button.offset()).deep.equal({left: 72, top:8});
// //     })
// //   });
